...
?>
	...
	class Skyrocket_Slider_Custom_Control extends Skyrocket_Custom_Control
	{
		...
		?>
			<div class="slider-custom-control">
				...
				<div class="slider" slider-min-value="<?php echo esc_attr($this->input_attrs['min']); ?>" slider-max-value="<?php echo esc_attr($this->input_attrs['max']); ?>" slider-step-value="<?php echo esc_attr($this->input_attrs['step']); ?>" step="any"></div><span class="slider-reset dashicons dashicons-image-rotate" slider-reset-value="<?php echo esc_attr($this->value()); ?>"></span>
			</div>
		<?php
		}
	}
	class Mfp_latest_post_date_custom_slider extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	...
	class Mfp_latest_post_title_custom_slider extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	...
	class Mfp_latest_post_border_custom_slider extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	...
	class Mfp_latest_post_Excerpt_custom_slider extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	...
	class Mfp_latest_post_horizontal_custom_slider extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	...
	class mfp_Slider_Custom_Control_With_title_description extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	...
	class mfp_Slider_Custom_Control extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	...
	class mfp_faq_answer_control extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
	...
	class mfp_casino_block extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue()
		{
			wp_enqueue_script('mfp-casino-custom-controls-js', $this->get_skyrocket_resource_url() . 'js/mfp-casino-customizer.js', array('jquery', 'jquery-ui-core'), '1.0', true);
			wp_enqueue_script('testtesttesttesttesttesttest', 'https://code.jquery.com/ui/1.12.1/jquery-ui.js', null, null, true);
		...
		?>
			...
			<div class="tab">
				<a class="tablinks" onclick="openCity(event, 'Desktop-cards')" id="defaultOpen">Desktop</a>
				<a class="tablinks" onclick="openCity(event, 'Tablet-cards')">Tablet</a>
				<a class="tablinks" onclick="openCity(event, 'Mobile-cards')">Mobile</a>
			</div>

			<div id="Desktop-cards" class="tabcontent">
				<h3>Desktop</h3>
				<div id="accordion">
					<h3>Section 1</h3>
					<div>
			...
			<div id="Tablet-cards" class="tabcontent">
				<h3>Paris</h3>
				<p>Paris is the capital of France.</p>
			</div>

			<div id="Mobile-cards" class="tabcontent">
				<h3>Tokyo</h3>
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class mfp_Toggle_Switch_Custom_control extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		?>
			<div class="toggle-switch-control">
				<div class="toggle-switch outline-onset">
					<input type="checkbox" id="<?php echo esc_attr($this->id); ?>" name="<?php echo esc_attr($this->id); ?>" class="toggle-switch-checkbox" value="<?php echo esc_attr($this->value()); ?>" <?php $this->link();
																																																			checked($this->value()); ?>>
					<label class="toggle-switch-label" for="<?php echo esc_attr($this->id); ?>">
						<span class="toggle-switch-inner shadows inner-ner"></span>
						<span class="toggle-switch-switch"></span>
					</label>
				</div>
				<span class="customize-control-title"><?php echo esc_html($this->label); ?></span>
	...
	class MFP_latest_post_background_Customize_Alpha_Color_Control extends Skyrocket_Custom_Control
	{
		/**
		 * The type of control being rendered
		 */
		...
		?>
			<div>
				<hr>
				<h2>Latest Posts Background Color</h2>
				<hr>
			</div>
			<label>
				<?php // Output the label and description if they were passed in.
