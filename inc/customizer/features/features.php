...
function mfp_features_controls($wp_customize)
{
    ...
    $wp_customize->add_section(
        ...
        array(
            'title' => __('Scroll Bar Indicator', 'mediafairplay'),
            'description' => esc_html__('', 'mediafairplay'),
            'panel' => 'mfp_features_panel'
        )
    );
    $wp_customize->add_setting( 'display_indicator',
    array(
       'default' => 1,
       'transport' => 'refresh',
       'sanitize_callback' => 'skyrocket_switch_sanitization'
 ...
 $wp_customize->add_control( new Skyrocket_Toggle_Switch_Custom_control( $wp_customize, 'display_indicator',
    array(
       'label' => esc_html__( 'Display Indicator' ),
       'section' => 'mfp_header_scroll_bar_section'
    )
 ) );
    $wp_customize->add_setting( 'indicator_bg',
   array(
      'default' => '#d6d35d',
      'transport' => 'refresh',
      'sanitize_callback' => 'skyrocket_hex_rgba_sanitization'
...
$wp_customize->add_control( new Skyrocket_Customize_Alpha_Color_Control( $wp_customize, 'indicator_bg',
   array(
      'label' => __( 'Color' ),
      'description' => esc_html__( '' ),
      'section' => 'mfp_header_scroll_bar_section',
    ...
    $wp_customize->add_setting(
        'mfp_header_Last_Modifited_toggle',
        array(
            'default' => 0,
            'transport' => 'refresh',
            'sanitize_callback' => 'skyrocket_switch_sanitization'
